  ...
  <table className="w-full border-collapse rounded-2xl overflow-hidden">
    ...
    <tbody>
      ...
      <tr className="border-b border-border hover:bg-amber-50 dark:hover:bg-zinc-700">
        ...
        <td className="py-5 px-6 text-foreground">The Calendar of Zcash related Events. You can check it on [Luma](https://luma.com/zcash) and [Zcash Foundation](https://zfnd.org/zf-events/)</td>
      </tr>
      <tr className="hover:bg-amber-50 dark:hover:bg-zinc-700">
...
<div className="overflow-x-auto my-8 rounded-3xl border border-border bg-card p-6">
  <table className="w-full border-collapse rounded-2xl overflow-hidden">
    ...
    <tbody>
      <tr className="border-b border-border hover:bg-amber-50 dark:hover:bg-zinc-700">
        <td className="py-5 px-6 font-medium text-foreground">Recovery Phase</td>
  ...
  <table className="w-full border-collapse rounded-2xl overflow-hidden">
    ...
    <tbody>
      <tr className="hover:bg-amber-50 dark:hover:bg-zinc-700">
        ...
        <td className="py-5 px-6 text-foreground">Software or hardware that stores private keys and lets you send/receive ZEC. Examples: Zecwallet, Nighthawk, YWallet, Zingo!. For more wallets you can view it [here](https://z.cash/ecosystem/?wallets=#tag-wallets).</td>
      </tr>
    </tbody>
  </table>
</div>
